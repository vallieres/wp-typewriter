	...
	function do_markdown($content) {
		if (!class_exists('Michelf\MarkdownExtra')) {
			spl_autoload_register(function ($class) {
				require_once plugin_dir_path(__FILE__) . 'includes/markdown/Michelf/MarkdownExtra.php';
				require_once plugin_dir_path(__FILE__) . 'includes/markdown/Michelf/Markdown.php';
				require_once plugin_dir_path(__FILE__) . 'includes/markdown/Michelf/MarkdownInterface.php';
			});
		}
